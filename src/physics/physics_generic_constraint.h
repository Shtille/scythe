#ifndef __SCYTHE_PHYSICS_GENERIC_CONSTRAINT_H__
#define __SCYTHE_PHYSICS_GENERIC_CONSTRAINT_H__
...
namespace scythe {
	...
	protected:
		 ...
		 * the constraint_ member variable to be initialized.
		 */
	...
	private:
		...
		mutable Quaternion * rotation_offset_a_;
		mutable Quaternion * rotation_offset_b_;
		mutable Vector3 * translation_offset_a_;
		mutable Vector3 * translation_offset_b_;
	};

} // namespace scythe

#include "physics_generic_constraint.inl"

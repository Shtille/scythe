...
namespace scythe {
	...
	{
		if (near_.Distance(point) <= 0)
			return false;
		if (far_.Distance(point) <= 0)
			return false;
		if (left_.Distance(point) <= 0)
			return false;
		if (right_.Distance(point) <= 0)
			return false;
		if (top_.Distance(point) <= 0)
			return false;
		if (bottom_.Distance(point) <= 0)
			return false;

...
//------------------------------------------------------------------------
// Content view class for the Scythe window
//------------------------------------------------------------------------
...
- (void) keyDown:(NSEvent *)theEvent
{
	...
	for (i = 0; i < length; ++i)
	{
		...
		{
			if (input_listener)
				input_listener->OnChar(codepoint);
		}
	}
}
...
- (void) mouseDown:(NSEvent *)theEvent
{
	...
	if (input_listener)
		input_listener->OnMouseDown(scythe::MouseButton::kLeft, TranslateModifiers([theEvent modifierFlags]));
}
...
- (void) mouseUp:(NSEvent *)theEvent
{
	...
	if (input_listener)
		input_listener->OnMouseUp(scythe::MouseButton::kLeft, TranslateModifiers([theEvent modifierFlags]));
}
...
- (void) rightMouseDown:(NSEvent *)theEvent
{
	...
	if (input_listener)
		input_listener->OnMouseDown(scythe::MouseButton::kRight, TranslateModifiers([theEvent modifierFlags]));
}
...
- (void) rightMouseUp:(NSEvent *)theEvent
{
	...
	if (input_listener)
		input_listener->OnMouseUp(scythe::MouseButton::kRight, TranslateModifiers([theEvent modifierFlags]));
}
...
- (void) otherMouseDown:(NSEvent *)theEvent
{
	...
	if (input_listener)
		input_listener->OnMouseDown(button, TranslateModifiers([theEvent modifierFlags]));
}
...
- (void) otherMouseUp:(NSEvent *)theEvent
{
	...
	if (input_listener)
		input_listener->OnMouseUp(button, TranslateModifiers([theEvent modifierFlags]));
}
...
- (void) scrollWheel:(NSEvent *)theEvent
{
	...
	scythe::DesktopInputListener * input_listener = app->GetInputListener()->Upcast<scythe::DesktopInputListener>();
	if (input_listener)
		input_listener->OnScroll(delta_x, delta_y);
}

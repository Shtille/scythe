 ...
 * velocity. Note that a constant velocity is not necessarily a requirement for a curve;
 ...
 * squad (spherical spline interpolation): interpolating between a series of rotations using slerp 
 ...
 * The slerp method provided here is intended for interpolation of principal rotations. It treats 
 * +q and -q as the same principal rotation and is at liberty to use the negative of either input. 
...
public:
	...
	*/
	...
	/**
	 * Sets the quaternion equal to the rotation to basis with the 
	 * desired direction vector.
	 * 
	 * @param from The start point of direction.
	 * @param at The end point of direction.
	 */
	void Set(const Vector3& from, const Vector3& at);
	 ...
	 *
	 * @param e The vector which stores the axis.
	 * 

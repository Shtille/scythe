#ifndef __SCYTHE_VECTOR3_H__
#define __SCYTHE_VECTOR3_H__
...
public:
	...
	/**
	 * Constructs a new vector initialized to the specified value.
	 *
	 * @param x The value.
	 */
	Vector3(float x);
	...
	/**
	 * Takes component-wise minimum (floor) value from original and given one.
	 *
...
/**
 * Calculates the dot product for given vectors.
 * 
 * @param v1 The first vector.
 * @param v2 The second vector.
...
/**
 * Calculates the cross product for given vectors.
 * 
 * @param v1 The first vector.
 * @param v2 The second vector.
 * @return The product value.
